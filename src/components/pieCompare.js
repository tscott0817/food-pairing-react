...
function PieCompare({item1Data, item2Data, sharedMolecules}) {
    ...
    return (
        <div style={{ display: 'flex', backgroundColor: '#f2f2f2', padding: '20px', borderRadius: '8px' }}>
            {/*<div style={{flex: 1, height: 400, marginRight: '20px'}}>*/}
            <div style={{ backgroundColor: "green", minWidth: '25vw', width: '50%', height: '50vh', marginRight: '1%'}}>
            ...
            <div style={{ backgroundColor: "green", minWidth: '25vw', width: '50%', height: '50vh'}}>
